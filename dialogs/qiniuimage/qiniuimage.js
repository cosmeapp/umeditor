...
// F.QiniuUploader = QiniuUploader;
    ...
    var Upload = {
        showCount: 0,
        uploadTpl: '<div id=\"J_FormPhotoIcon%%\" class="edui-image-upload%%">' +
        ...
        render: function (sel, t) {
            ...
            instance.uploader.bind('Error', function(uploader, files){
                // loadingInstance.loading("hide");
            });
            instance.uploader.bind('FileUploaded', function(uploader, file, info){
                // loadingInstance.loading("hide");
    ...
    UM.registerWidget('qiniuimage', {
        ...
        initContent: function (editor, $dialog) {
            var lang = editor.getLang('image')["static"],
                opt = $.extend({}, lang, {
                    image_url: UMEDITOR_CONFIG.UMEDITOR_HOME_URL + 'dialogs/qiniuimage/'
                });
